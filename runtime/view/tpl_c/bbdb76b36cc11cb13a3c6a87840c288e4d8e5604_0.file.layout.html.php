<?php
/* Smarty version 3.1.30, created on 2018-10-06 01:13:42
  from "C:\xampp\htdocs\iou.cn\application\home\view\layout.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5bb79bc6a43051_70794201',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bbdb76b36cc11cb13a3c6a87840c288e4d8e5604' => 
    array (
      0 => 'C:\\xampp\\htdocs\\iou.cn\\application\\home\\view\\layout.html',
      1 => 1538759609,
      2 => 'file',
    ),
  ),
...
function content_5bb79bc6a43051_70794201 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="aw-top-menu-wrap" style="margin-top: 20px">
    <div class="container">
        <!-- logo -->
        ...
        <div class="aw-search-box  hidden-xs hidden-sm">
            <form method="post" id="global_search_form" action="?/search/" class="navbar-search">
                <input type="text" id="aw-search-query" name="q" autocomplete="off" placeholder="搜索问题、话题或人"
                       class="form-control search-query" style="float: left;width: 30%;">
                <!--<span onclick="$('#global_search_form').submit();" id="global_search_btns" title="搜索"> -->
                <i class="icon icon-search" style="height: 30px;line-height:30px;margin-left:-3%;"></i>
                <!--</span>-->
        ...
        <!-- end 搜索框 -->
        <!-- 导航 -->
        <div class="aw-top-nav navbar" style="float: left;margin-top: -3.7%">
            ...
            <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
                <ul class="nav navbar-nav">
                    <li>
                        <a class="active" href="index.html"> <i class="icon icon-list"></i>发现</a>
                    </li>
                    <li>
        ...
        <div class="aw-user-nav" style="float: left;margin-top: -2.6%">
            <!-- 登陆&注册栏 -->
            <a href="?c=user&a=loginAction" class="login btn btn-normal btn-primary">登录</a>
            <a href="?m=home&c=user&a=registerAction" class="register btn btn-normal btn-success">注册</a>
            <!-- end 登陆&注册栏 -->
        </div>
        <?php } else { ?>
        <!-- 登陆成功展示用户栏 -->
        <div class="aw-user-nav" style="margin-top: -30px;text-align: right">
            <!-- 登陆&注册栏 -->
            <a class="aw-user-nav-dropdown" href="people.html">
                <img src="<?php echo PUBLIC_PATH;?>
common/avatar-mid-img.png" alt="itbull"></a>
            <div class="aw-dropdown dropdown-list pull-right" style="margin-top: -3%;">
        ...
        <!-- end 用户栏 -->
        <!-- 发起 -->
        <div class="aw-publish-btn" style="float: left;margin: -39px 0 0 170px;">
            <div class="dropdown-list pull-right">
                <a href="<?php echo framework\core\Factory::URL('home/question/add');?>
">发起问题</a>
            </div>
        </div>
        <!-- end 发起 -->
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_58745bb79bc6a3bf78_58610311', "content");
?>

<div class="aw-footer-wrap">
    <div class="aw-footer" style="display: block;width: 100%;text-align: center;margin-top: 30px;">
...
<?php }
/* {block "content"} */
class Block_58745bb79bc6a3bf78_58610311 extends Smarty_Internal_Block
{
