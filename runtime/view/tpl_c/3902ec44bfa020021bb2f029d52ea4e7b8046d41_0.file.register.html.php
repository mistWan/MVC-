<?php
/* Smarty version 3.1.30, created on 2018-09-28 22:56:51
  from "C:\xampp\htdocs\iou.cn\application\home\view\user\register.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5bae4133eed491_20692986',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3902ec44bfa020021bb2f029d52ea4e7b8046d41' => 
    array (
      0 => 'C:\\xampp\\htdocs\\iou.cn\\application\\home\\view\\user\\register.html',
      1 => 1538146607,
      2 => 'file',
    ),
  ),
...
function content_5bae4133eed491_20692986 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
		...
		<form id="register_form" action="?m=home&c=user&a=doRegisterAction" method="post" class="aw-register-form">
			...
			<ul>
				...
				<li class="aw-register-verify">
					<img src="?m=home&c=user&a=makeCaptchaAction" onclick="Code()" id="captcha" class="pull-right">

					<input type="text" placeholder="验证码" name="seccode_verify" class="form-control captcha"></li>
				<li class="last">
					<label>
				...
				<li class="clearfix">
					<input type="submit" value="注册" class="btn btn-large btn-blue btn-block" style="background: #66afe9;">
				</li>
			</ul>
		</form>
	</div>
