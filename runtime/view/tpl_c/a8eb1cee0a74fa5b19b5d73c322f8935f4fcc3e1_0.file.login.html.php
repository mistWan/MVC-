<?php
/* Smarty version 3.1.30, created on 2018-09-28 12:52:43
  from "C:\xampp\htdocs\iou.cn\application\home\view\user\login.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5badb39bb2bc16_00773058',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a8eb1cee0a74fa5b19b5d73c322f8935f4fcc3e1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\iou.cn\\application\\home\\view\\user\\login.html',
      1 => 1538110354,
      2 => 'file',
    ),
  ),
...
function content_5badb39bb2bc16_00773058 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
	<div class="aw-login-box">
		<div class="mod-body clearfix">
			<div class="content pull-left">
				...
				<form action="?c=user&a=doLoginAction" method="post" id="login_form">
					...
					<ul>
						<li>
							<input type="text" name="user_name" placeholder="邮箱 / 用户名" class="form-control" id="aw-login-user-name" style="margin: 20px auto;"></li>
						<li>
							<input type="password" name="password" placeholder="密码" class="form-control" id="aw-login-user-password" style="margin: 20px auto;"></li>
						<li class="alert alert-danger hide error_message"> <i class="icon icon-delete"></i> <em></em>
						</li>

						<li class="last">
							<input type="submit" value="登录" class="pull-right btn btn-large btn-primary" style="background: #66afe9;width: 200px">
                            <br>
							<label>
		...
		<div class="mod-footer">
			<span>还没有账号?</span>
			&nbsp;&nbsp;
			<a href="?c=user&a=registerAction">立即注册</a>
			&nbsp;&nbsp;•&nbsp;&nbsp;
			<a href="">游客访问</a>
		</div>
	</div>
